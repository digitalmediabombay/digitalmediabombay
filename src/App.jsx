...
const FullPricingPage = ({ pricinfunction FullPricingPage({ pricingMode, currencySymbol, openBundles, onContactClick }) {gMode, currencySymbol, openBundles, onContactClick }) => {
